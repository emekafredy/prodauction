...
ActiveRecord::Schema[7.0].define(version: 2023_11_21_173136) do
  ...
  create_table "items", force: :cascade do |t|
    ...
    t.text "delivery_options", default: ["Pickup", "Home Delivery"], array: true
  ...
  create_table "wallets", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "user_id", null: false
    t.string "gateway", default: "Paystack", null: false
    t.string "customer_id"
    t.decimal "balance", precision: 16, scale: 2, default: "0.0"
    t.decimal "last_deposit", precision: 16, scale: 2, default: "0.0"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
